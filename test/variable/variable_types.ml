    ...
    test_case "i16" `Quick (fun () ->
        ...
        check Mocks.stmt_testable "name is x with type int and value none"
          ...
          @@ `Let
               {
                 name = "x";
                 ty = Some (Mocks.mk_types (`TInt 16));
                 value = Mocks.mk_expr (`Int 0);
               }));
    ...
    test_case "i64" `Quick (fun () ->
        ...
        check Mocks.stmt_testable "name is x with type int and value none"
          ...
          @@ `Let
               {
                 name = "x";
                 ty = Some (Mocks.mk_types (`TInt 64));
                 value = Mocks.mk_expr (`Int 0);
               }));
    test_case "i128" `Quick (fun () ->
        ...
        check Mocks.stmt_testable "name is x with type int and value none"
          ...
          @@ `Let
               {
                 name = "x";
                 ty = Some (Mocks.mk_types (`TInt 128));
                 value = Mocks.mk_expr (`Int 0);
               }));
    test_case "uint" `Quick (fun () ->
        ...
        check Mocks.stmt_testable "name is x with type int and value none"
          ...
          @@ `Let
               {
                 name = "x";
                 ty = Some (Mocks.mk_types (`TUint 32));
                 value = Mocks.mk_expr (`Int 0);
               }));
    test_case "u8" `Quick (fun () ->
        ...
        check Mocks.stmt_testable "name is x with type int and value none"
          ...
          @@ `Let
               {
                 name = "x";
                 ty = Some (Mocks.mk_types (`TUint 8));
                 value = Mocks.mk_expr (`Int 0);
               }));
    test_case "u16" `Quick (fun () ->
        ...
        check Mocks.stmt_testable "name is x with type int and value none"
          ...
          @@ `Let
               {
                 name = "x";
                 ty = Some (Mocks.mk_types (`TUint 16));
                 value = Mocks.mk_expr (`Int 0);
               }));
    ...
    test_case "u64" `Quick (fun () ->
        ...
        check Mocks.stmt_testable "name is x with type int and value none"
          ...
          @@ `Let
               {
                 name = "x";
                 ty = Some (Mocks.mk_types (`TUint 64));
                 value = Mocks.mk_expr (`Int 0);
               }));
    test_case "u128" `Quick (fun () ->
        ...
        check Mocks.stmt_testable "name is x with type int and value none"
          ...
          @@ `Let
               {
                 name = "x";
                 ty = Some (Mocks.mk_types (`TUint 128));
                 value = Mocks.mk_expr (`Int 0);
               }));
    ...
    test_case "f32" `Quick (fun () ->
        ...
        check Mocks.stmt_testable "name is x with type int and value none"
          ...
          @@ `Let
               {
                 name = "x";
                 ty = Some (Mocks.mk_types (`TFloat 32));
                 value = Mocks.mk_expr (`Float 0.0);
               }));
